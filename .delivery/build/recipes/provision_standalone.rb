...
ruby_block 'stand-up-machine' do
  block do
    ...
    shell_out_retry("chef exec chef-client -z -p 10257 -j #{attributes_install_file} -c #{repo_config_file} -o qa-chef-server-cluster::standalone-server --force-formatter")
  end
end
